...
class XverseDecoderLayer(nn.Module):
    ...
    def _forward_aiter_fp8(
        ...
        """XverseMoE decoder forward with fused add+RMSNorm+FP8 for attention (AMD AITER).
        ...
        the standard allreduce+norm path since XverseMoE does not accept FP8 input.
        """
        ...
        # MLP: allreduce (TP>1) + standard RMSNorm (MoE doesn't support FP8 input)
