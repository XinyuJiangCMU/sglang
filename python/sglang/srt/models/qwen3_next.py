...
class Qwen3HybridAttentionDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        # Skip when captured_last_layer_outputs is requested (falls back to standard
        # prepare_attn_and_capture_last_layer_outputs path which handles it correctly).
        if (
            self._aiter_fp8
